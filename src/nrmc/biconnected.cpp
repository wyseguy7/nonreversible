...
#define __PYX_HAVE__nrmc__biconnected
#define __PYX_HAVE_API__nrmc__biconnected
/* Early includes */
#include "ios"
#include "new"
#include "stdexcept"
...
struct __pyx_t_4nrmc_11biconnected_StackInner;

/* "nrmc/biconnected.pyx":13
 * 
 * 
...
/* Module declarations from 'nrmc.biconnected' */
static PyTypeObject *__pyx_array_type = 0;
static PyTypeObject *__pyx_MemviewEnum_type = 0;
static PyTypeObject *__pyx_memoryview_type = 0;
static PyTypeObject *__pyx_memoryviewslice_type = 0;
static int __pyx_v_4nrmc_11biconnected_ROT_MATRIX[2][2];
...
static int __pyx_f_4nrmc_11biconnected_fast_min(int, int); /*proto*/
static float __pyx_f_4nrmc_11biconnected_dot_product(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_4nrmc_11biconnected_calculate_com_inner(__Pyx_memviewslice, double, __Pyx_memviewslice, double, int __pyx_skip_dispatch); /*proto*/
static std::vector<int>  __pyx_f_4nrmc_11biconnected_biconnected_dfs(std::vector<int> , std::unordered_map<int,std::vector<int> > , int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "nrmc.biconnected"
extern int __pyx_module_is_main_nrmc__biconnected;
int __pyx_module_is_main_nrmc__biconnected = 0;

/* Implementation of 'nrmc.biconnected' */
...
static const char __pyx_k_node_adj[] = "node_adj";
...
static const char __pyx_k_com_weight[] = "com_weight";
static const char __pyx_k_pyx_result[] = "__pyx_result";
static const char __pyx_k_pyx_vtable[] = "__pyx_vtable__";
static const char __pyx_k_MemoryError[] = "MemoryError";
static const char __pyx_k_PickleError[] = "PickleError";
static const char __pyx_k_grandparent[] = "grandparent";
static const char __pyx_k_com_centroid[] = "com_centroid";
...
static PyObject *__pyx_n_s_com_centroid;
static PyObject *__pyx_n_s_com_weight;
...
static PyObject *__pyx_n_s_node_adj;
...
static PyObject *__pyx_pf_4nrmc_11biconnected_dot_product(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_b, __Pyx_memviewslice __pyx_v_center); /* proto */
static PyObject *__pyx_pf_4nrmc_11biconnected_2calculate_com_inner(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_centroid, double __pyx_v_weight, __Pyx_memviewslice __pyx_v_com_centroid, double __pyx_v_com_weight); /* proto */
static PyObject *__pyx_pf_4nrmc_11biconnected_4biconnected_dfs(CYTHON_UNUSED PyObject *__pyx_self, std::vector<int>  __pyx_v_node_list, std::unordered_map<int,std::vector<int> >  __pyx_v_node_adj); /* proto */
...
static int __pyx_f_4nrmc_11biconnected_fast_min(int __pyx_v_a, int __pyx_v_b) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  __Pyx_RefNannySetupContext("fast_min", 0);

  /* "nrmc/biconnected.pyx":19
 * 
 * cdef int fast_min(int a, int b):
 *     if a < b:             # <<<<<<<<<<<<<<
 *         return a
...
static PyObject *__pyx_pw_4nrmc_11biconnected_1dot_product(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static float __pyx_f_4nrmc_11biconnected_dot_product(__Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_b, __Pyx_memviewslice __pyx_v_center, CYTHON_UNUSED int __pyx_skip_dispatch) {
  float __pyx_v_vec_a_b[2];
  float __pyx_v_midpoint[2];
  float __pyx_v_vec_perp_center[2];
  float __pyx_v_vec_from_center[2];
  float __pyx_v_dp;
  float __pyx_v_norm_center;
  float __pyx_v_norm_a_b;
  long __pyx_v_i;
  float __pyx_r;
  __Pyx_RefNannyDeclarations
  long __pyx_t_1;
 ...
 * 
 */
  __pyx_v_norm_center = 0.;

  /* "nrmc/biconnected.pyx":33
 *     cdef float dp = 0.
 *     cdef float norm_center = 0.
 *     cdef float norm_a_b = 0.             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    (__pyx_v_vec_a_b[__pyx_v_i]) = ((*((double *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_2 * __pyx_v_b.strides[0]) ))) - (*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_4 * __pyx_v_a.strides[0]) ))));

    /* "nrmc/biconnected.pyx":38
 *     for i in range(2):
 *         vec_a_b[i] = b[i] - a[i]
 *         midpoint[i] = vec_a_b[i]*0.5 + a[i]             # <<<<<<<<<<<<<<
 *         vec_from_center[i] = midpoint[i] - center[i]
 ...
 */
    ...
    (__pyx_v_midpoint[__pyx_v_i]) = (((__pyx_v_vec_a_b[__pyx_v_i]) * 0.5) + (*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_4 * __pyx_v_a.strides[0]) ))));

    /* "nrmc/biconnected.pyx":39
 *         vec_a_b[i] = b[i] - a[i]
 *         midpoint[i] = vec_a_b[i]*0.5 + a[i]
 *         vec_from_center[i] = midpoint[i] - center[i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    if (__pyx_t_4 < 0) {
      ...
      if (unlikely(__pyx_t_4 < 0)) __pyx_t_3 = 0;
    } else if (unlikely(__pyx_t_4 >= __pyx_v_center.shape[0])) __pyx_t_3 = 0;
    if (unlikely(__pyx_t_3 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_3);
      __PYX_ERR(0, 39, __pyx_L1_error)
    }
    (__pyx_v_vec_from_center[__pyx_v_i]) = ((__pyx_v_midpoint[__pyx_v_i]) - (*((double *) ( /* dim=0 */ (__pyx_v_center.data + __pyx_t_4 * __pyx_v_center.strides[0]) ))));
  }

  /* "nrmc/biconnected.pyx":41
 *         vec_from_center[i] = midpoint[i] - center[i]
 * 
 *     vec_perp_center[0] = -1.0 * vec_from_center[1]             # <<<<<<<<<<<<<<
 ...
 * 
 */
  (__pyx_v_vec_perp_center[0]) = (-1.0 * (__pyx_v_vec_from_center[1]));

  /* "nrmc/biconnected.pyx":42
 * 
 *     vec_perp_center[0] = -1.0 * vec_from_center[1]
 *     vec_perp_center[1] = vec_from_center[0]             # <<<<<<<<<<<<<<
 * 
 *     for i in range(2):
 */
  (__pyx_v_vec_perp_center[1]) = (__pyx_v_vec_from_center[0]);

  /* "nrmc/biconnected.pyx":44
 *     vec_perp_center[1] = vec_from_center[0]
 * 
 *     for i in range(2):             # <<<<<<<<<<<<<<
 ...
 */
    __pyx_v_dp = (__pyx_v_dp + ((__pyx_v_vec_a_b[__pyx_v_i]) * (__pyx_v_vec_perp_center[__pyx_v_i])));

    /* "nrmc/biconnected.pyx":47
 *         # dp += vec_a_b[i]*vec_from_center[i]
 *         dp += vec_a_b[i]*vec_perp_center[i]
 *         norm_center += vec_perp_center[i]**2             # <<<<<<<<<<<<<<
 *         norm_a_b += vec_a_b[i]**2
 * 
 */
    __pyx_v_norm_center = (__pyx_v_norm_center + powf((__pyx_v_vec_perp_center[__pyx_v_i]), 2.0));

    /* "nrmc/biconnected.pyx":48
 *         dp += vec_a_b[i]*vec_perp_center[i]
 *         norm_center += vec_perp_center[i]**2
 *         norm_a_b += vec_a_b[i]**2             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_v_norm_a_b = (__pyx_v_norm_a_b + powf((__pyx_v_vec_a_b[__pyx_v_i]), 2.0));
  }

  /* "nrmc/biconnected.pyx":50
 *         norm_a_b += vec_a_b[i]**2
 * 
 *     return dp/sqrt(norm_center)/sqrt(norm_a_b)             # <<<<<<<<<<<<<<
 * 
 * 
 */
  __pyx_t_5 = sqrt(__pyx_v_norm_center);
  if (unlikely(__pyx_t_5 == 0)) {
    PyErr_SetString(PyExc_ZeroDivisionError, "float division");
    __PYX_ERR(0, 50, __pyx_L1_error)
  }
  __pyx_t_6 = (__pyx_v_dp / __pyx_t_5);
  __pyx_t_5 = sqrt(__pyx_v_norm_a_b);
  if (unlikely(__pyx_t_5 == 0)) {
    PyErr_SetString(PyExc_ZeroDivisionError, "float division");
    __PYX_ERR(0, 50, __pyx_L1_error)
  }
  __pyx_r = (__pyx_t_6 / __pyx_t_5);
  goto __pyx_L0;
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("nrmc.biconnected.dot_product", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_4nrmc_11biconnected_1dot_product(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_4nrmc_11biconnected_1dot_product(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_a,&__pyx_n_s_b,&__pyx_n_s_center,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_b)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("dot_product", 1, 3, 3, 1); __PYX_ERR(0, 25, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_center)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("dot_product", 1, 3, 3, 2); __PYX_ERR(0, 25, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "dot_product") < 0)) __PYX_ERR(0, 25, __pyx_L3_error)
      }
    ...
    __pyx_v_a = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_a.memview)) __PYX_ERR(0, 25, __pyx_L3_error)
    __pyx_v_b = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_b.memview)) __PYX_ERR(0, 25, __pyx_L3_error)
    __pyx_v_center = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_center.memview)) __PYX_ERR(0, 25, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("dot_product", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 25, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("nrmc.biconnected.dot_product", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4nrmc_11biconnected_dot_product(__pyx_self, __pyx_v_a, __pyx_v_b, __pyx_v_center);
...
static PyObject *__pyx_pf_4nrmc_11biconnected_dot_product(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_b, __Pyx_memviewslice __pyx_v_center) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("dot_product", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_a.memview)) { __Pyx_RaiseUnboundLocalError("a"); __PYX_ERR(0, 25, __pyx_L1_error) }
  if (unlikely(!__pyx_v_b.memview)) { __Pyx_RaiseUnboundLocalError("b"); __PYX_ERR(0, 25, __pyx_L1_error) }
  if (unlikely(!__pyx_v_center.memview)) { __Pyx_RaiseUnboundLocalError("center"); __PYX_ERR(0, 25, __pyx_L1_error) }
  __pyx_t_1 = PyFloat_FromDouble(__pyx_f_4nrmc_11biconnected_dot_product(__pyx_v_a, __pyx_v_b, __pyx_v_center, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 25, __pyx_L1_error)
...
static PyObject *__pyx_pw_4nrmc_11biconnected_3calculate_com_inner(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_4nrmc_11biconnected_calculate_com_inner(__Pyx_memviewslice __pyx_v_centroid, double __pyx_v_weight, __Pyx_memviewslice __pyx_v_com_centroid, double __pyx_v_com_weight, CYTHON_UNUSED int __pyx_skip_dispatch) {
  double __pyx_v_weighted_centroid[2];
  ...
  __Pyx_RefNannySetupContext("calculate_com_inner", 0);

  /* "nrmc/biconnected.pyx":66
 * 
 * 
 ...
 */
  ...
  __pyx_t_2 = -1;
  if (__pyx_t_1 < 0) {
    __pyx_t_1 += __pyx_v_centroid.shape[0];
    if (unlikely(__pyx_t_1 < 0)) __pyx_t_2 = 0;
  } else if (unlikely(__pyx_t_1 >= __pyx_v_centroid.shape[0])) __pyx_t_2 = 0;
  if (unlikely(__pyx_t_2 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_2);
    __PYX_ERR(0, 66, __pyx_L1_error)
  }
  (__pyx_v_weighted_centroid[0]) = (__pyx_v_weight * (*((double *) ( /* dim=0 */ (__pyx_v_centroid.data + __pyx_t_1 * __pyx_v_centroid.strides[0]) ))));

  /* "nrmc/biconnected.pyx":67
 * 
 *     weighted_centroid[0] = weight*centroid[0]
 *     weighted_centroid[1] = weight*centroid[1]             # <<<<<<<<<<<<<<
 *     # centroid[1] *= weight # now a weighted centroid
 ...
 */
  ...
  (__pyx_v_weighted_centroid[1]) = (__pyx_v_weight * (*((double *) ( /* dim=0 */ (__pyx_v_centroid.data + __pyx_t_1 * __pyx_v_centroid.strides[0]) ))));

  /* "nrmc/biconnected.pyx":72
 ...
 *     for i in range(2):
 */
  (__pyx_v_output[2]) = (__pyx_v_weight + __pyx_v_com_weight);

  /* "nrmc/biconnected.pyx":74
 *     output[2] = weight + com_weight
 * 
 *     for i in range(2):             # <<<<<<<<<<<<<<
 ...
 */
    ...
    __pyx_t_2 = -1;
    if (__pyx_t_1 < 0) {
      __pyx_t_1 += __pyx_v_com_centroid.shape[0];
      if (unlikely(__pyx_t_1 < 0)) __pyx_t_2 = 0;
    } else if (unlikely(__pyx_t_1 >= __pyx_v_com_centroid.shape[0])) __pyx_t_2 = 0;
    if (unlikely(__pyx_t_2 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_2);
      __PYX_ERR(0, 75, __pyx_L1_error)
    }
    __pyx_t_4 = ((__pyx_v_weighted_centroid[__pyx_v_i]) + ((*((double *) ( /* dim=0 */ (__pyx_v_com_centroid.data + __pyx_t_1 * __pyx_v_com_centroid.strides[0]) ))) * __pyx_v_com_weight));
    if (unlikely((__pyx_v_output[2]) == 0)) {
      PyErr_SetString(PyExc_ZeroDivisionError, "float division");
      __PYX_ERR(0, 75, __pyx_L1_error)
    }
    (__pyx_v_output[__pyx_v_i]) = (__pyx_t_4 / (__pyx_v_output[2]));
  }

  /* "nrmc/biconnected.pyx":77
 *         output[i] = (weighted_centroid[i] + com_centroid[i]*com_weight)/output[2]
 * 
 *     return output             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_5 = __Pyx_carray_to_py_double(__pyx_v_output, 3); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 77, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_AddTraceback("nrmc.biconnected.calculate_com_inner", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static PyObject *__pyx_pw_4nrmc_11biconnected_3calculate_com_inner(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_4nrmc_11biconnected_3calculate_com_inner(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_centroid = { 0, 0, { 0 }, { 0 }, { 0 } };
  double __pyx_v_weight;
  __Pyx_memviewslice __pyx_v_com_centroid = { 0, 0, { 0 }, { 0 }, { 0 } };
  double __pyx_v_com_weight;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("calculate_com_inner (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_centroid,&__pyx_n_s_weight,&__pyx_n_s_com_centroid,&__pyx_n_s_com_weight,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_centroid)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_weight)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("calculate_com_inner", 1, 4, 4, 1); __PYX_ERR(0, 53, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_com_centroid)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("calculate_com_inner", 1, 4, 4, 2); __PYX_ERR(0, 53, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_com_weight)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("calculate_com_inner", 1, 4, 4, 3); __PYX_ERR(0, 53, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "calculate_com_inner") < 0)) __PYX_ERR(0, 53, __pyx_L3_error)
      }
    ...
    __pyx_v_centroid = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_centroid.memview)) __PYX_ERR(0, 53, __pyx_L3_error)
    __pyx_v_weight = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_weight == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 53, __pyx_L3_error)
    __pyx_v_com_centroid = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_com_centroid.memview)) __PYX_ERR(0, 54, __pyx_L3_error)
    __pyx_v_com_weight = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_com_weight == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 54, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("calculate_com_inner", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 53, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("nrmc.biconnected.calculate_com_inner", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4nrmc_11biconnected_2calculate_com_inner(__pyx_self, __pyx_v_centroid, __pyx_v_weight, __pyx_v_com_centroid, __pyx_v_com_weight);
...
static PyObject *__pyx_pf_4nrmc_11biconnected_2calculate_com_inner(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_centroid, double __pyx_v_weight, __Pyx_memviewslice __pyx_v_com_centroid, double __pyx_v_com_weight) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("calculate_com_inner", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_centroid.memview)) { __Pyx_RaiseUnboundLocalError("centroid"); __PYX_ERR(0, 53, __pyx_L1_error) }
  if (unlikely(!__pyx_v_com_centroid.memview)) { __Pyx_RaiseUnboundLocalError("com_centroid"); __PYX_ERR(0, 53, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_4nrmc_11biconnected_calculate_com_inner(__pyx_v_centroid, __pyx_v_weight, __pyx_v_com_centroid, __pyx_v_com_weight, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 53, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_centroid, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_com_centroid, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}

/* "nrmc/biconnected.pyx":81
 * 
...
static PyObject *__pyx_pw_4nrmc_11biconnected_5biconnected_dfs(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static std::vector<int>  __pyx_f_4nrmc_11biconnected_biconnected_dfs(std::vector<int>  __pyx_v_node_list, std::unordered_map<int,std::vector<int> >  __pyx_v_node_adj, CYTHON_UNUSED int __pyx_skip_dispatch) {
  std::unordered_set<int>  __pyx_v_visited;
  int __pyx_v_start;
  std::unordered_map<int,int>  __pyx_v_discovery;
  std::unordered_map<int,int>  __pyx_v_low;
  int __pyx_v_root_children;
  std::vector<struct __pyx_t_4nrmc_11biconnected_StackInner>  __pyx_v_stack;
  std::vector<int>  __pyx_v_output;
  struct __pyx_t_4nrmc_11biconnected_StackInner __pyx_v_last_el;
  std::vector<int> ::size_type __pyx_v_i;
  int __pyx_v_grandparent;
  int __pyx_v_parent;
  ...
  int __pyx_t_4;
  struct __pyx_t_4nrmc_11biconnected_StackInner __pyx_t_5;
  int __pyx_t_6;
  std::vector<int>  __pyx_t_7;
  __Pyx_RefNannySetupContext("biconnected_dfs", 0);

  /* "nrmc/biconnected.pyx":91
 ...
 *         # start = it.first
 */
  __pyx_t_1 = __pyx_v_node_list.size();
  __pyx_t_2 = __pyx_t_1;
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_i = __pyx_t_3;

    /* "nrmc/biconnected.pyx":101
 *     # for it in node_adj.begin():
 *         # start = it.first
 *         start = node_list[i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_v_start = (__pyx_v_node_list[__pyx_v_i]);

    /* "nrmc/biconnected.pyx":103
 *         start = node_list[i]
 * 
 *         if visited.count(start) !=0:             # <<<<<<<<<<<<<<
 *             continue
 * 
 */
    __pyx_t_4 = ((__pyx_v_visited.count(__pyx_v_start) != 0) != 0);
    if (__pyx_t_4) {

      /* "nrmc/biconnected.pyx":104
 * 
 *         if visited.count(start) !=0:
 *             continue             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
    __pyx_v_discovery.clear();

    /* "nrmc/biconnected.pyx":107
 * 
 *         discovery.clear()
 *         low.clear()             # <<<<<<<<<<<<<<
 * 
 ...
 *         root_children = 0
 */
    (__pyx_v_discovery[__pyx_v_start]) = 0;

    /* "nrmc/biconnected.pyx":111
 *         # TODO getting python useage here
 *         discovery[start] = 0
 *         low[start] = 0             # <<<<<<<<<<<<<<
 *         root_children = 0
 ...
 */
    (__pyx_v_low[__pyx_v_start]) = 0;

    /* "nrmc/biconnected.pyx":112
 *         discovery[start] = 0
 *         low[start] = 0
 *         root_children = 0             # <<<<<<<<<<<<<<
 *         visited.insert(start)
 ...
 *         stack.clear()
 */
    (void)(__pyx_v_visited.insert(__pyx_v_start));

    /* "nrmc/biconnected.pyx":115
 *         visited.insert(start)
 * 
 *         stack.clear()             # <<<<<<<<<<<<<<
 ...
 *         while stack.size() > 0:
 */
    __pyx_t_5.grandparent = __pyx_v_start;
    __pyx_t_5.parent = __pyx_v_start;
    __pyx_t_5.children = (__pyx_v_node_adj[__pyx_v_start]);
    try {
      __pyx_v_stack.push_back(__pyx_t_5);
    } catch(...) {
      __Pyx_CppExn2PyErr();
      __PYX_ERR(0, 116, __pyx_L1_error)
    }

    /* "nrmc/biconnected.pyx":118
 *         stack.push_back(StackInner(start, start, node_adj[start]))
 *         # stack.push_back(StackInner(start, start, it.second))
 *         while stack.size() > 0:             # <<<<<<<<<<<<<<
 ...
 */
      __pyx_v_last_el = __pyx_v_stack.back();

      /* "nrmc/biconnected.pyx":120
 *         while stack.size() > 0:
 *             last_el = stack.back() # will this work?
 *             grandparent = last_el.grandparent             # <<<<<<<<<<<<<<
 *             parent = last_el.parent
 ...
 */
      __pyx_t_6 = __pyx_v_last_el.grandparent;
      __pyx_v_grandparent = __pyx_t_6;

      /* "nrmc/biconnected.pyx":121
 *             last_el = stack.back() # will this work?
 *             grandparent = last_el.grandparent
 *             parent = last_el.parent             # <<<<<<<<<<<<<<
 *             children = last_el.children
 * 
 */
      __pyx_t_6 = __pyx_v_last_el.parent;
      __pyx_v_parent = __pyx_t_6;

      /* "nrmc/biconnected.pyx":122
 *             grandparent = last_el.grandparent
 *             parent = last_el.parent
 *             children = last_el.children             # <<<<<<<<<<<<<<
 * 
 *             if children.size() > 0:
 */
      __pyx_t_7 = __pyx_v_last_el.children;
      __pyx_v_children = __pyx_t_7;

      /* "nrmc/biconnected.pyx":124
 *             children = last_el.children
 * 
 *             if children.size() > 0:             # <<<<<<<<<<<<<<
 ...
 */
      __pyx_t_4 = ((__pyx_v_children.size() > 0) != 0);
      if (__pyx_t_4) {

        /* "nrmc/biconnected.pyx":125
 * 
 *             if children.size() > 0:
 *                 child = children.back() # TODO make this work with pointers             # <<<<<<<<<<<<<<
 *                 stack.back().children.pop_back() # will this have the requisite side effects?
 *                 children.pop_back()
 */
        __pyx_v_child = __pyx_v_children.back();

        /* "nrmc/biconnected.pyx":126
 *             if children.size() > 0:
 *                 child = children.back() # TODO make this work with pointers
 *                 stack.back().children.pop_back() # will this have the requisite side effects?             # <<<<<<<<<<<<<<
 *                 children.pop_back()
 * 
 */
        __pyx_v_stack.back().children.pop_back();

        /* "nrmc/biconnected.pyx":127
 *                 child = children.back() # TODO make this work with pointers
 *                 stack.back().children.pop_back() # will this have the requisite side effects?
 *                 children.pop_back()             # <<<<<<<<<<<<<<
 * 
 ...
 */
        __pyx_v_children.pop_back();

        /* "nrmc/biconnected.pyx":129
 *                 children.pop_back()
 * 
 *                 if grandparent == child:             # <<<<<<<<<<<<<<
 *                     # print("p2")
 *                     continue
 */
        __pyx_t_4 = ((__pyx_v_grandparent == __pyx_v_child) != 0);
        if (__pyx_t_4) {

          /* "nrmc/biconnected.pyx":131
 *                 if grandparent == child:
 *                     # print("p2")
 *                     continue             # <<<<<<<<<<<<<<
 * 
 ...
 */
        __pyx_t_4 = ((__pyx_v_visited.count(__pyx_v_child) != 0) != 0);
        if (__pyx_t_4) {

          /* "nrmc/biconnected.pyx":134
 * 
 *                 if visited.count(child) !=0:
 *                     if discovery[child] <= discovery[parent]:  # back edge             # <<<<<<<<<<<<<<
 *                         low[parent] = fast_min(low[parent], discovery[child])
 *                 else:
 */
          __pyx_t_4 = (((__pyx_v_discovery[__pyx_v_child]) <= (__pyx_v_discovery[__pyx_v_parent])) != 0);
          if (__pyx_t_4) {

            /* "nrmc/biconnected.pyx":135
 *                 if visited.count(child) !=0:
 *                     if discovery[child] <= discovery[parent]:  # back edge
 *                         low[parent] = fast_min(low[parent], discovery[child])             # <<<<<<<<<<<<<<
 *                 else:
 ...
 */
            (__pyx_v_low[__pyx_v_parent]) = __pyx_f_4nrmc_11biconnected_fast_min((__pyx_v_low[__pyx_v_parent]), (__pyx_v_discovery[__pyx_v_child]));
 ...
 */
        /*else*/ {
          (__pyx_v_low[__pyx_v_child]) = __pyx_v_discovery.size();

          /* "nrmc/biconnected.pyx":138
 *                 else:
 *                     low[child] = discovery.size()
 *                     discovery[child] = discovery.size()             # <<<<<<<<<<<<<<
 *                     visited.insert(child)
 ...
 */
          (__pyx_v_discovery[__pyx_v_child]) = __pyx_v_discovery.size();

          /* "nrmc/biconnected.pyx":139
 *                     low[child] = discovery.size()
 *                     discovery[child] = discovery.size()
 *                     visited.insert(child)             # <<<<<<<<<<<<<<
 *                     stack.push_back(StackInner(parent, child, node_adj[child]))
 *             else:
 */
          (void)(__pyx_v_visited.insert(__pyx_v_child));

          /* "nrmc/biconnected.pyx":140
 *                     discovery[child] = discovery.size()
 *                     visited.insert(child)
 *                     stack.push_back(StackInner(parent, child, node_adj[child]))             # <<<<<<<<<<<<<<
 *             else:
 * 
 */
          __pyx_t_5.grandparent = __pyx_v_parent;
          __pyx_t_5.parent = __pyx_v_child;
          __pyx_t_5.children = (__pyx_v_node_adj[__pyx_v_child]);
          try {
            __pyx_v_stack.push_back(__pyx_t_5);
          } catch(...) {
            __Pyx_CppExn2PyErr();
 ...
 */
        __pyx_t_4 = ((__pyx_v_stack.size() > 1) != 0);
        if (__pyx_t_4) {

          /* "nrmc/biconnected.pyx":145
 *                 stack.pop_back()
 *                 if stack.size() > 1:
 *                     if low[parent] >= discovery[grandparent]:             # <<<<<<<<<<<<<<
 *                         output.push_back(grandparent)
 ...
 */
          __pyx_t_4 = (((__pyx_v_low[__pyx_v_parent]) >= (__pyx_v_discovery[__pyx_v_grandparent])) != 0);
          if (__pyx_t_4) {

            /* "nrmc/biconnected.pyx":146
 *                 if stack.size() > 1:
 *                     if low[parent] >= discovery[grandparent]:
 *                         output.push_back(grandparent)             # <<<<<<<<<<<<<<
 *                     low[grandparent] = fast_min(low[parent], low[grandparent])
 ...
 */
            try {
              __pyx_v_output.push_back(__pyx_v_grandparent);
            } catch(...) {
              __Pyx_CppExn2PyErr();
 ...
 *                     root_children += 1
 */
          (__pyx_v_low[__pyx_v_grandparent]) = __pyx_f_4nrmc_11biconnected_fast_min((__pyx_v_low[__pyx_v_parent]), (__pyx_v_low[__pyx_v_grandparent]));
 ...
 *             #yield start
 */
    __pyx_t_4 = ((__pyx_v_root_children > 1) != 0);
    if (__pyx_t_4) {

      /* "nrmc/biconnected.pyx":152
 *             # root node is articulation point if it has more than 1 child
 *         if root_children > 1:
 *             output.push_back(start)             # <<<<<<<<<<<<<<
 *             #yield start
 ...
 */
      try {
        __pyx_v_output.push_back(__pyx_v_start);
      } catch(...) {
        __Pyx_CppExn2PyErr();
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("nrmc.biconnected.biconnected_dfs", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
...
/* Python wrapper */
static PyObject *__pyx_pw_4nrmc_11biconnected_5biconnected_dfs(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_4nrmc_11biconnected_5biconnected_dfs(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  std::vector<int>  __pyx_v_node_list;
  std::unordered_map<int,std::vector<int> >  __pyx_v_node_adj;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("biconnected_dfs (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_node_list,&__pyx_n_s_node_adj,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_node_adj)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("biconnected_dfs", 1, 2, 2, 1); __PYX_ERR(0, 81, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "biconnected_dfs") < 0)) __PYX_ERR(0, 81, __pyx_L3_error)
      }
    ...
    __pyx_v_node_list = __pyx_convert_vector_from_py_int(values[0]); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 81, __pyx_L3_error)
    __pyx_v_node_adj = __pyx_convert_unordered_map_from_py_int__and_std_3a__3a_vector_3c_int_3e___(values[1]); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 81, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("biconnected_dfs", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 81, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("nrmc.biconnected.biconnected_dfs", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4nrmc_11biconnected_4biconnected_dfs(__pyx_self, __pyx_v_node_list, __pyx_v_node_adj);
...
static PyObject *__pyx_pf_4nrmc_11biconnected_4biconnected_dfs(CYTHON_UNUSED PyObject *__pyx_self, std::vector<int>  __pyx_v_node_list, std::unordered_map<int,std::vector<int> >  __pyx_v_node_adj) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("biconnected_dfs", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_convert_vector_to_py_int(__pyx_f_4nrmc_11biconnected_biconnected_dfs(__pyx_v_node_list, __pyx_v_node_adj, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 81, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
 ...
 */
    ...
    __pyx_t_8 = __pyx_convert_vector_from_py_int(__pyx_v_value); if (unlikely(PyErr_Occurred())) __PYX_ERR(2, 178, __pyx_L1_error)
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "nrmc.biconnected.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "nrmc.biconnected.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "nrmc.biconnected._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"dot_product", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4nrmc_11biconnected_1dot_product, METH_VARARGS|METH_KEYWORDS, 0},
  {"calculate_com_inner", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4nrmc_11biconnected_3calculate_com_inner, METH_VARARGS|METH_KEYWORDS, 0},
  {"biconnected_dfs", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4nrmc_11biconnected_5biconnected_dfs, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_biconnected(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_biconnected},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_com_centroid, __pyx_k_com_centroid, sizeof(__pyx_k_com_centroid), 0, 0, 1, 1},
  {&__pyx_n_s_com_weight, __pyx_k_com_weight, sizeof(__pyx_k_com_weight), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_node_adj, __pyx_k_node_adj, sizeof(__pyx_k_node_adj), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initbiconnected(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initbiconnected(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_biconnected(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_biconnected(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_biconnected(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  static int __pyx_t_1[2];
  static int __pyx_t_2[2];
  static int __pyx_t_3[2][2];
  PyObject *__pyx_t_4 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'biconnected' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_biconnected(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("biconnected", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_nrmc__biconnected) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "nrmc.biconnected")) {
      if (unlikely(PyDict_SetItemString(modules, "nrmc.biconnected", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  memcpy(&(__pyx_v_4nrmc_11biconnected_ROT_MATRIX[0]), __pyx_t_3, sizeof(__pyx_v_4nrmc_11biconnected_ROT_MATRIX[0]) * (2));

  /* "nrmc/biconnected.pyx":1
 ...
 * cdef indirect = Enum("<strided and indirect>")
 */
  __pyx_t_4 = __Pyx_PyObject_Call(((PyObject *)__pyx_MemviewEnum_type), __pyx_tuple__19, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(2, 286, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
 ...
 * 
 */
  __pyx_t_4 = __Pyx_PyObject_Call(((PyObject *)__pyx_MemviewEnum_type), __pyx_tuple__20, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(2, 287, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
 ...
 * 
 */
  __pyx_t_4 = __Pyx_PyObject_Call(((PyObject *)__pyx_MemviewEnum_type), __pyx_tuple__21, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(2, 288, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
 ...
 * 
 */
  __pyx_t_4 = __Pyx_PyObject_Call(((PyObject *)__pyx_MemviewEnum_type), __pyx_tuple__22, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(2, 291, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
 ...
 * 
 */
  __pyx_t_4 = __Pyx_PyObject_Call(((PyObject *)__pyx_MemviewEnum_type), __pyx_tuple__23, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(2, 292, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init nrmc.biconnected", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init nrmc.biconnected");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
